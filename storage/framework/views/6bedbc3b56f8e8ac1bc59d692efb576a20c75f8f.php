        ...
        <div id="c-p3-2" class="accordion-collapse collapse" aria-labelledby="p3-2" data-bs-parent="#p3">
            <div class="accordion-body">
                ...
                <div class="row">
                    ...
                    <img src="<?php echo e(asset('img/data-scientist-pathway.png')); ?>" class="col-md-6">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('modules.data-scientist-part.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/career-module/resources/views/modules/data-scientist-part/part-3.blade.php ENDPATH**/ ?>