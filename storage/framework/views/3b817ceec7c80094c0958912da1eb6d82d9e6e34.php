            ...
            <div class="accordion accordion-flush" id="p1">
                ...
                <div class="accordion-item">
                    ...
                    <div id="c-p1-1" class="accordion-collapse collapse show" aria-labelledby="p1-1" data-bs-parent="#p1">
                        <div class="accordion-body row" style="text-align: left;">
                            <img src="<?php echo e(asset('img/yt-recommended.png')); ?>" class="col-md-6">
                            <div class="col-md-6">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-2" aria-expanded="false" aria-controls="c-p1-2">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-3">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-3" aria-expanded="false" aria-controls="c-p1-3">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-4">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-4" aria-expanded="false" aria-controls="c-p1-4">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                            Data Scientist as a career
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-5">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-5" aria-expanded="false" aria-controls="c-p1-5">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-6">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-6" aria-expanded="false" aria-controls="c-p1-6">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-7">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-7" aria-expanded="false" aria-controls="c-p1-7">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-8">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-8" aria-expanded="false" aria-controls="c-p1-8">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-9">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-9" aria-expanded="false" aria-controls="c-p1-9">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                            Concept Check
                        </button>
                    </h2>
                    ...
                    <div id="c-p1-9" class="accordion-collapse collapse" aria-labelledby="p1-9" data-bs-parent="#p1">
                        <div class="accordion-body">
                            ...
                            <img src="<?php echo e(asset('img/topic-1-concept-check.png')); ?>" class="rounded mx-auto d-block">
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="p1-10">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#c-p1-10" aria-expanded="false" aria-controls="c-p1-10">
                            <i class="far fa-check-circle pe-2" id="icon2-1"></i>
                            Testimony
                        </button>
                    </h2>
