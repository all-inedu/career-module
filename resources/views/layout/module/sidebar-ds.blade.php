<ul class="list-group rounded-0" id="sidebar-list">
    <li class="list-group-item {{ Request::is('data-scientist/1') ? 'sidebar-active' : 'sidebar-unactive' }}">
        <a class="sidebar-elements" id="part-0" href="{{ url('data-scientist/1') }}">Part 1 <i class="" id="iconPart1"></i></a>
    </li>
